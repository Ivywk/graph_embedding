...
def parameter_parser():
    ...
    parser.add_argument("--input-path-0",
                        nargs="?",
                        default="../image_dataset/0_nm/",
	                help="Input folder with jsons.")

    parser.add_argument("--input-path-40",
                        nargs="?",
                        default="../image_dataset/40_nm/",
	                help="Input folder with jsons.")

    parser.add_argument("--input-path-100",
                        nargs="?",
                        default="../image_dataset/100_nm/",
	                help="Input folder with jsons.")

    parser.add_argument("--output-path",
                        nargs="?",
                        default="../features/nci4.csv",
